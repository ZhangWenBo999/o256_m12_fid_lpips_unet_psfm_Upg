...
from module_test.psfm_upg import *
...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        self._feature_size += ch
        # self.psfm = PSFM(Channel=ch)
        self.psfm_upg = UpgradedPSFM(Channel=ch)
        # self.cdfa_123 = CDFA(in_c=ch, out_c=ch)
    ...
    def forward(self, x, gammas):
        ...
        h2 = h
        # h = self.cdfa_123(h2, h1, h2)
        h = self.psfm_upg([h1, h2])
